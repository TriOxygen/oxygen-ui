    ...
    return (
      <Paper className={demoStyles.container} fullWidth={false}>
        ...
        <RadioGroup value={1}>
          ...
          <Radio fullWidth label={'2'} value={2} color={mdTheme.primary} />
          <Radio fullWidth label={'3'} value={3} color={mdTheme.secondary}/>
          <Radio fullWidth label={'4'} value={4} color={mdTheme.tertiary}/>
