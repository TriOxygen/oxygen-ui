...
var DrawerContainer = function (_Component) {
  ...
  _createClass(DrawerContainer, [{
    ...
    value: function render() {
      ...
      var onRequestOpen = _props.onRequestOpen;
      var onRequestClose = _props.onRequestClose;
      var closeOnEsc = _props.closeOnEsc;
      var foo = _props.position;

      var other = _objectWithoutProperties(_props, ['overlay', 'width', 'right', 'children', 'onRequestOpen', 'onRequestClose', 'closeOnEsc', 'position']);
