...
var _templateObject = _taggedTemplateLiteral(['Cancel'], ['Cancel']),
    _templateObject2 = _taggedTemplateLiteral(['Ok'], ['Ok']);
...
(0, _I18n.addMessages)(_defineProperty({}, 'en-US', {
  'Cancel': 'Cancel',
  'Ok': 'Ok'
}));
...
var DialogContainer = function (_Component) {
  ...
  function DialogContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DialogContainer)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
...
DialogContainer.defaultProps = {
  cancel: (0, _I18n.translate)(_templateObject),
  ok: (0, _I18n.translate)(_templateObject2)
};
