...
var ListItem = function (_Component) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['payload', 'divider', 'dense', 'padded', 'children', 'leftElement', 'rightElement', 'style', 'onTouchTap']);

      var leftComponent = void 0;
      var rightComponent = void 0;
      if (leftElement) {
        leftComponent = _react2.default.cloneElement(leftElement, { className: styles.leftComponent });
      }
      if (rightElement) {
        rightComponent = _react2.default.createElement(
          'div',
          null,
          _react2.default.cloneElement(rightElement, { className: styles.rightComponent })
        );
      }
      var rootClasses = (0, _classnames2.default)(styles.root, (_classNames = {}, _defineProperty(_classNames, styles.padded, padded), _defineProperty(_classNames, styles.interactive, onTouchTap), _defineProperty(_classNames, styles.dense, dense), _classNames));
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          leftElement,
          onTouchTap && _react2.default.createElement(_Ink2.default, null),
          _react2.default.createElement(
            _View2.default,
