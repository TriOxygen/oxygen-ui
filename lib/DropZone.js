...
var DropZone = function (_Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var disablePreview = _props.disablePreview;
      var onDropAccepted = _props.onDropAccepted;
      var disableClick = _props.disableClick;
      var onDropRejected = _props.onDropRejected;

      var other = _objectWithoutProperties(_props, ['accept', 'inputProps', 'multiple', 'name', 'className', 'children', 'disablePreview', 'onDropAccepted', 'disableClick', 'onDropRejected']);
