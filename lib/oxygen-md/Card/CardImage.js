...
var CardImage = function (_Component) {
  ...
  _createClass(CardImage, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['className', 'title', 'subtitle']);

      return _react2.default.createElement(
        'div',
        { className: css.container },
        _react2.default.createElement('img', _extends({}, other, { className: (0, _classnames2.default)(className, css.cardImage) })),
        _react2.default.createElement(
          ...
          typeof subtitle === 'string' ? _react2.default.createElement(
            'h3',
