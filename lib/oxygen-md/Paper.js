...
var Paper = function (_Component) {
  ...
  _createClass(Paper, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['children', 'spaced', 'padded', 'rounded', 'className', 'hover']);

      var classes = (0, _classnames2.default)(className, styles.root, (_classNames = {}, _defineProperty(_classNames, styles.spaced, spaced), _defineProperty(_classNames, styles.padded, padded), _defineProperty(_classNames, styles.rounded, rounded), _classNames));
      var props = {
        className: classes,
        style: this.getStyle()
      };
