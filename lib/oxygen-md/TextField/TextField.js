...
var TextField = function (_Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['placeholder', 'fullWidth', 'dense', 'defaultValue', 'floatingLabelText', 'icon', 'children', 'className', 'onTouchTap', 'errorText']);
      ...
      var rootClasses = (0, _classnames2.default)(styles.root, className, (_classNames = {}, _defineProperty(_classNames, styles.fullWidth, fullWidth), _defineProperty(_classNames, styles.hasIcon, icon), _defineProperty(_classNames, styles.dense, dense), _defineProperty(_classNames, styles.hasFloatingLabel, floatingLabelText), _classNames));
...
var styles = {
  ...
  fullWidth: 'omd_dY',
  dense: 'omd_dZ',
  iconContainer: 'omd_d0',
  hasFloatingLabel: 'omd_d1',
  errorText: 'omd_d2',
  hasIcon: 'omd_d3'
};
