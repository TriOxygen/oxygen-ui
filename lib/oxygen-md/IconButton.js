...
var IconButton = function (_Component) {
  ...
  _createClass(IconButton, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['dense', 'disabled', 'children', 'className', 'link']);

      var ink = !disabled && _react2.default.createElement(_Ink2.default, null);
      var buttonClasses = (0, _classnames2.default)(styles.iconButton, className, dense ? styles.dense : null);
