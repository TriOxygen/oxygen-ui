...
var Heading = function (_Component) {
  ...
  _createClass(Heading, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)(css.root, (_classNames = {}, _defineProperty(_classNames, css.display4, display4), _defineProperty(_classNames, css.display3, display3), _defineProperty(_classNames, css.display2, display2), _defineProperty(_classNames, css.display1, display1), _defineProperty(_classNames, css.subheading, subheading), _defineProperty(_classNames, css.title, title), _classNames));
