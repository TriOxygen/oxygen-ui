...
var styles = {
  ...
  row: 'oui_gg',
  middle: 'oui_gh',
  verticalAlign: 'oui_gi',
  responsiveRow: 'oui_gj',
  column: 'oui_gk'
};
...
var View = function (_Component) {
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['className', 'middle', 'auto', 'wrap', 'row', 'column', 'children', 'responsiveRow', 'grow']);

      var classes = (0, _classnames2.default)(className, styles.root, (_classNames = {}, _defineProperty(_classNames, styles.row, row), _defineProperty(_classNames, styles.wrap, wrap), _defineProperty(_classNames, styles.verticalAlign, auto), _defineProperty(_classNames, styles.middle, middle), _defineProperty(_classNames, styles.responsiveRow, responsiveRow), _defineProperty(_classNames, styles.column, !row && column), _classNames));
