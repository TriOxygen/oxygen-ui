...
var View = function (_Component) {
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['className', 'row', 'column', 'children', 'responsiveRow']);

      var classes = (0, _classnames2.default)(className, styles.root, (_classNames = {}, _defineProperty(_classNames, styles.row, row), _defineProperty(_classNames, styles.responsiveRow, responsiveRow), _defineProperty(_classNames, styles.column, !row && column), _classNames));
