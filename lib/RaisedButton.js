...
var RaisedButton = function (_Component) {
  ...
  _createClass(RaisedButton, [{
    ...
    value: function render() {
      ...
      var buttonClasses = (0, _classnames2.default)(styles.raisedButton, (_classNames = {}, _defineProperty(_classNames, styles.dense, dense), _defineProperty(_classNames, styles.disabled, disabled), _defineProperty(_classNames, styles.fullWidth, fullWidth), _classNames));
      var props = _extends({
