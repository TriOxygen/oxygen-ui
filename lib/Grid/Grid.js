...
var Grid = function (_Component) {
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)(css.grid, className, (_classNames = {}, _defineProperty(_classNames, css.top, top), _defineProperty(_classNames, css.center, center), _defineProperty(_classNames, css.bottom, bottom), _defineProperty(_classNames, css.gutter, gutter), _defineProperty(_classNames, css.center, center), _classNames));
