...
var Text = function (_Component) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['padded', 'spaced', 'fullWidth', 'primary', 'secondary', 'children', 'className']);

      var shade = this.context.mdTheme.shade;

      var classes = (0, _classnames2.default)(css.root, className, shade === 'light' ? css.dark : css.light, (_classNames = {}, _defineProperty(_classNames, css.secondary, secondary), _defineProperty(_classNames, css.padded, padded), _defineProperty(_classNames, css.fullWidth, fullWidth), _defineProperty(_classNames, css.spaced, spaced), _classNames));
