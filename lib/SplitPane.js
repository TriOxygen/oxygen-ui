      ...
      return _react2.default.createElement(
        ...
        function (interpolated) {
          var leftStyle = void 0,
              rightStyle = void 0;
          var progress = interpolated.progress > 1 ? 1 : interpolated.progress;
          var rightWidth = width - _this2.props.leftWidth;
          var left = Math.round(width - rightWidth * progress);
          if (width) {
            leftStyle = {
              width: left
            };
          ...
          return _react2.default.createElement(
            'div',
            { className: css.root, style: { overflow: progress ? 'hidden' : null } },
