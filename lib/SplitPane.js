...
var _Styles = require('oxygen-md/Styles');

var _oxygenMd = require('oxygen-md');
...
var SplitPane = function (_Component) {
  ...
  function SplitPane() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SplitPane)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      ...
      _this._width = width;
      _this.setState({ hasChild: _this.state.hasChild });
  ...
  _createClass(SplitPane, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactMotion.Motion,
        { style: { progress: (0, _reactMotion.spring)(hasChild ? 1 : 0, { stiffness: 300, damping: 25 }) } },
