...
var TextField = function (_Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['placeholder', 'floatingLabelText', 'icon', 'children', 'className', 'onTouchTap', 'errorText']);
      ...
      var rootClasses = (0, _classnames2.default)(styles.root, className, (_classNames = {}, _defineProperty(_classNames, styles.hasIcon, icon), _defineProperty(_classNames, styles.hasFloatingLabel, floatingLabelText), _classNames));
      var placeHolderClasses = (0, _classnames2.default)(placeHolderStyles.root, (_classNames2 = {}, _defineProperty(_classNames2, placeHolderStyles.hasIcon, icon), _defineProperty(_classNames2, placeHolderStyles.hasFloatingLabel, floatingLabelText), _classNames2));
...
var styles = {
  root: 'omd_bI',
  hasFloatingLabel: 'omd_bJ',
  errorText: 'omd_bK',
  iconContainer: 'omd_bL',
  hasIcon: 'omd_bM'
};
