...
var Menu = function (_Component) {
  ...
  function Menu() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Menu)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onMenuItemTap = function (furtherTap, payload, label) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['children', 'padded']);
