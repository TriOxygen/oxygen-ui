...
var Dialog = function (_Component) {
  ...
  function Dialog() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Dialog)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleRequestOpen = function () {
      ...
      var open = _this$props3.open;
      var onOpen = _this$props3.onOpen;
  ...
  _createClass(Dialog, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactMotion.Motion,
        { style: { y: (0, _reactMotion.spring)(open ? 100 : 0, { stiffness: 300, damping: 25 }), opacity: (0, _reactMotion.spring)(open ? 1 : 0) }, onRest: this.handleRest },
        function (interpolated) {
          if (interpolated.opacity > 0) {
            return _react2.default.createElement(
              _DialogContainer2.default,
              _extends({}, interpolated, { top: open ? 0 : -100, onRequestClose: _this2.handleRequestClose, onRequestOpen: _this2.handleRequestOpen }),
              children
            );
          }
          return null;
