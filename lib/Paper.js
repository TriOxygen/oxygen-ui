...
var Paper = function (_Component) {
  ...
  _createClass(Paper, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)(styles.root, className, (_classNames = {}, _defineProperty(_classNames, styles.fullWidth, fullWidth), _defineProperty(_classNames, styles.spaced, spaced), _defineProperty(_classNames, styles.padded, padded), _defineProperty(_classNames, styles.rounded, rounded), _classNames));
      var props = {
        className: classes,
        style: this.getStyle()
      };
