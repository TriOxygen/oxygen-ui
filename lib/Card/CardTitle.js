...
var CardTitle = function (_Component) {
  ...
  _createClass(CardTitle, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['children', 'padded', 'className']);

      var classes = (0, _classnames2.default)(className, css.title, (_classNames = {}, _defineProperty(_classNames, css.dark, mdTheme.shade === 'dark'), _defineProperty(_classNames, css.padded, padded), _classNames));
