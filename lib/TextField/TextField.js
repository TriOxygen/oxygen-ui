  ...
  _createClass(TextField, [{
    ...
    value: function getStyles() {
      ...
      return {
        ...
        underline: {
          borderColor: errorText ? _Styles.Colors.material.red[500].hex : mdTheme.text.divider,
          transform: focused ? 'scaleX(1)' : null
        },
        underlineActive: {
          borderColor: focused ? colors[500].hex : errorText ? _Styles.Colors.material.red[500].hex : mdTheme.text.divider,
          transform: focused ? 'scaleX(1)' : null
        },
        label: {
    ...
    value: function renderInputElement(props) {
      ...
      if (readOnly) {
        ...
        if (multiline) {
          return _react2.default.createElement(_EnhancedTextArea2.default, _extends({}, props, {
            ref: 'input',
            className: inputStyles.root,
            type: type,
    ...
    value: function render() {
      ...
      var mdColor = _props3.mdColor;
      var multiline = _props3.multiline;
      var children = _props3.children;
      var className = _props3.className;
      var onTouchTap = _props3.onTouchTap;
      var errorText = _props3.errorText;
      var onPressEnter = _props3.onPressEnter;

      var other = _objectWithoutProperties(_props3, ['divider', 'placeholder', 'fullWidth', 'dense', 'defaultValue', 'floatingLabelText', 'icon', 'mdColor', 'multiline', 'children', 'className', 'onTouchTap', 'errorText', 'onPressEnter']);
      ...
      var rootClasses = (0, _classnames2.default)(css.root, className, (_classNames = {}, _defineProperty(_classNames, css.divider, divider), _defineProperty(_classNames, css.fullWidth, fullWidth), _defineProperty(_classNames, css.hasIcon, icon), _defineProperty(_classNames, css.dense, dense), _defineProperty(_classNames, css.hasFloatingLabel, floatingLabelText), _classNames));
      ...
      return _react2.default.createElement(
        'div',
        { className: rootClasses, onTouchTap: onTouchTap, style: styles.root },
        ...
        _react2.default.createElement(
          ...
          !divider && floatingLabelText && _react2.default.createElement('hr', { className: underlineStyles.root, style: styles.underline }),
          !divider && floatingLabelText && _react2.default.createElement('hr', { className: underlineClasses, style: styles.underlineActive }),
          floatingLabelEl,
          children
        ),
...
var css = {
  ...
  fullWidth: 'oui_fN',
  dense: 'oui_fO',
  iconContainer: 'oui_fP',
  hasFloatingLabel: 'oui_fQ',
  errorText: 'oui_fR',
  hasIcon: 'oui_fS',
  divider: 'oui_fT'
};
