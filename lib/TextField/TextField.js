...
var TextField = function (_Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props3, ['divider', 'placeholder', 'fullWidth', 'dense', 'defaultValue', 'floatingLabelText', 'icon', 'children', 'className', 'onTouchTap', 'errorText']);
...
var css = {
  ...
  fullWidth: 'omd_cb',
  dense: 'omd_cc',
  iconContainer: 'omd_cd',
  hasFloatingLabel: 'omd_ce',
  errorText: 'omd_cf',
  hasIcon: 'omd_cg',
  divider: 'omd_df'
};
